        ...
        const fetchHealthData = async () => {
            try {
                ...
                if (response.success) {
                    ...
                    const healthDates = response.healthGrpData?.map(
                        (item: {
                            healthMonth: number
                            yearValue: number
                            healthDay: number
                ...
                console.log('Error fetching health group data:', error)
            }
        }
        ...
        <div className='w-full'>
            <Card className='max-w-md mx-auto'>
                <CardHeader>
                    ...
                    <CardDescription>
                        Track your health check uploads
                    </CardDescription>
                </CardHeader>
